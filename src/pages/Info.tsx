  ...
  return (
    <div className="container" style={{ paddingBottom: 72 }}>
      ...
      <div className="story">
        ...
        <div>
          <p>
            وُلدت سمية في جديدة عرعر لتكون عنواناً واضحاً للأناقة الأنثوية: وردي ناعم، بيج دافئ،
    ...
    <div className="container" style={{ paddingBottom: 72 }}>
      ...
      <div className="contact-grid">
        ...
        {sent ? (
          <div className="card">
            <h3>وصلنا رسالتك</h3>
            <p>شكراً لتواصلك مع سمية. سنعود إليك في أقرب وقت.</p>
          </div>
        ) : (
          <form
            className="card form"
